...
* Final Project
  ...
  * Your grade for this comes from the following:
    ...
    * Fails to work for Android 10.0+: I'll be testing your apps likely on Google Pixel 3; however, might get an older phone running Android 10 out to insure it works for Android 19. But students code that fails to install or work correctly on Android 10 will lose points here.
