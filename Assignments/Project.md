...
* **Make sure your project aligns with the learning goals of a web and mobile app development course that is focused on client-side development**. Just because an app idea includes a web or mobile interface does not mean it will result in a successful final project.
